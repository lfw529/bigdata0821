...
object createrdd02_file {
  def main(args: Array[String]): Unit = {
    ...
    val lineWordRdd1: RDD[String] = sc.textFile("D:\\IdeaProjects\\bigdata0821\\SparkCoreTest0821\\input\\2.txt")
    //3.2 读取文件。如果是集群路径：hdfs://hadoop102:8020/input   --测试2
    val lineWordRdd2: RDD[String] = sc.textFile("hdfs://hadoop105:8020/input99")
