...
import com.lfw.flink.bean.ApacheLog;
import com.lfw.flink.bean.UrlCount;
...
public class Practice_HotUrl2 {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<UrlCount> urlCountByWindowDS = keyedStream
                ...
                .aggregate(new Practice_HotUrl.HotUrlAggFunc(), new Practice_HotUrl.HotUrlWindowFunc());
