...
public class EventTime_StreamToTable {
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<WaterSensor> waterSensorDS = env.readTextFile("D:\\IdeaProjects\\bigdata0821\\Flink_0821\\src\\main\\resources\\sensor.txt")
                .map(line -> {
