...
//        tableEnv.connect(new FileSystem().path("D:\\IdeaProjects\\bigdata0821\\Flink_0821\\out\\r.txt"))
//                .withFormat(new Csv())
...
////        tableEnv.from("sensorOutPut");             //Source 写法
//        selectTable.executeInsert("sensorOutPut"); //Sink 写法
//
//        //7.执行任务
//        env.execute();
//    }
