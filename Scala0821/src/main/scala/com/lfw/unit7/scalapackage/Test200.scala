...
package com.lfw { //包 com.lfw
  class User200 { //在com.lfw 包下创建个 User 类
  }
  package scala2 { //创建包 com.lfw.scala2
    class User200 { //在com.lfw.scala2 包下创建个 User 类
    }

  }

  package scala { //包 com.lfw.scala
    class Person200 { //表示在 com.lfw.scala 下创建类 Person
      val name = "Nick"
    ...
    object Test200 { //表示在 com.lfw.scala 创建object Test
