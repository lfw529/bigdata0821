...
object cache02 {
  def main(args: Array[String]): Unit = {
    ...
    /*
    (2) ShuffledRDD[4] at reduceByKey at cache02.scala:29 []
       +-(2) MapPartitionsRDD[3] at map at cache02.scala:19 []
          |  MapPartitionsRDD[2] at flatMap at cache02.scala:17 []
          |  SparkCoreTest_0821/input/3.txt MapPartitionsRDD[1] at textFile at cache02.scala:15 []
          |  SparkCoreTest_0821/input/3.txt HadoopRDD[0] at textFile at cache02.scala:15 []
      *************
      *************
      *************
     */
